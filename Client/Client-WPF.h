#pragma once
///////////////////////////////////////////////////////////////////////////
// Client-WPF.h - C++\CLI implementation of WPF Application              //
//          - solution for CSE 687 Project #4                            //
// ver 3.1                                                               //
...
*  --------------------
*  ver 3.1 : 3 May 2016
*  - added extraction tab, implement check in and show message 
*  ver 3.0 : 22 Apr 2016
...
#include "../ClientSupport/MockChannel.h"
#include <iostream>
...
namespace CppCliWindows
{
	ref class WPFCppCliDemo : Window
	{
		...
		TabItem^ hExtractionTab = gcnew TabItem();
		...
		Button^ hCheckinDoneButton = gcnew Button();
		Button^ hCancelCheckinButton = gcnew Button();
		Grid^ hGrid2 = gcnew Grid();

		// Controls for extraction view
		Grid^ hExtractionGrid = gcnew Grid();
		Button^ hGetPkgButton = gcnew Button();
		Button^ hDownloadButton1 = gcnew Button();
		Button^ hDownloadButton2 = gcnew Button();
		ListBox^ hExtractionListBox = gcnew ListBox();		
	...
	public:
		...
		void addPkgName(String^ msg);
		void getMessage();
		void clear(Object^ sender, RoutedEventArgs^ args);
		void checkInAction(Object^ sender, RoutedEventArgs^ args);
		void checkInDoneAction(Object^ sender, RoutedEventArgs^ args);
		void cancelCheckIn(Object^ sender, RoutedEventArgs^ args);
		void browseForFolder(Object^ sender, RoutedEventArgs^ args);
		void getPkgList(Object^ sender, RoutedEventArgs^ args);
		void download1(Object^ sender, RoutedEventArgs^ args);
		void download2(Object^ sender, RoutedEventArgs^ args);
