...
namespace XmlProcessing
{
	...
	inline std::vector<AbstractXmlElement::sPtr> AbstractXmlElement::children() { return std::vector<sPtr>(); }
	...
	inline std::vector<AbstractXmlElement::sPtr> DocElement::children() { return children_; }
